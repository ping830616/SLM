...
read_design -physical_data /home/aavyas1/research/IIR/IIR_RING/apr/IIR_filter.enc.dat IIR_filter 
read_def "/home/aavyas1/research/IIR/IIR_RING/apr/IIR_filter.def"
set_dc_sources VDD -power -voltage 1.1 -force
set_dc_sources VSS -ground
read_spef "/home/aavyas1/research/IIR/IIR_RING/apr/IIR_filter.spef.gz"
...
read_activity_file -format VCD /home/aavyas1/research/IIR/IIR_RING/apr/iir_sim/IIR_filter.vcd -start start_time -end end_time -scope IIR_filter_tb/dut
...
set_rail_analysis_mode -method dynamic \
   -accuracy hd \
   -power_grid_library {/home/aavyas1/research/IIR/IIR_RING/voltus/required_files/tech_pgv/techonly.cl} \
   -temp_directory_name ./tmp \
   -temperature 25 \
	  -limit_number_of_steps false \
	  -save_voltage_waveforms false \
	  -generate_movies false
set_pg_nets -net VDD -voltage 1.1 -threshold 0.8
...
set_power_pads -net VDD -format xy -file /home/aavyas1/research/IIR/IIR_RING/voltus/required_files/VDD.pp
set_power_pads -net VSS -format xy -file /home/aavyas1/research/IIR/IIR_RING/voltus/required_files/VSS.pp
