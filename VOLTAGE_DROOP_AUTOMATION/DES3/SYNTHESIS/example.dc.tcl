...
# library directory
set search_path [list "/home/aavyas1/libs/asap7libs/asap7libs_24/db/" ]
...
set netlist_search_path "/home/aavyas1/research/DES3/DES/rtl/des3"
# NETLIST NAME
set netlist_name "des3.v"
set file1 "crp.v"
set file2 "key_sel3.v"
set file3 "sbox1.v"
set file4 "sbox2.v"
set file5 "sbox3.v"
set file6 "sbox4.v"
...
analyze -format sverilog $netlist_search_path/$file1
analyze -format sverilog $netlist_search_path/$file2
analyze -format sverilog $netlist_search_path/$file3
analyze -format sverilog $netlist_search_path/$file4
analyze -format sverilog $netlist_search_path/$file5
analyze -format sverilog $netlist_search_path/$file6
analyze -format sverilog $netlist_search_path/$file7
analyze -format sverilog $netlist_search_path/$file8
analyze -format sverilog $netlist_search_path/$file9
analyze -format sverilog $netlist_search_path/$file10
elaborate $top_level
list_designs
