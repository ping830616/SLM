...
# #################################CHANGE THIS###################################################
# TOP_LEVEL_NAME
set top_level 			"adder16"
# PATH TO YOUR VERILOG NETLIST
# set netlist_search_path "/home/aavyas1/research/fir_ring15/rtl"
# set netlist_search_path "/home/aavyas1/research/jonti/jpegencode/synth"
# NETLIST NAME
# set netlist_name "jpeg_top.v"
# CLOCK PERIOD
set clk_period 			900
# ################################################################################################
...
# Read verilog files
read_file {/home/aavyas1/research/Jonti_Transfers/SLM_RAS/FP_Units/RTL/} -autoread -format verilog -top adder16
