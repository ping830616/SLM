...
-strmFile 'mux_16_1.gds' \
-attachTechFileOfLib 'asap7_TechLib'  \
-topCell 'mux_16_1'  \
-logFile 'strmIn.log'  \
-layerMap '/afs/asu.edu/class/e/e/e/eee525b/asap7/asap7PDK/cdslib/asap7_TechLib/asap7_TechLib.layermap'  \
-refLibList 'strminref.txt'  \
-objectMap '/afs/asu.edu/class/e/e/e/eee525b/asap7/asap7PDK/cdslib/asap7_TechLib/asap7_TechLib.objectmap' \
-scale '0.25' 
